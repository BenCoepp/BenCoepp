  ...
  data() {
    return {
      ...
      skillsItems: [
        {
          ...
          imgUrl: 'assets/images/skills/java.png',
          title: 'Java'
        }, {
          imgUrl: 'assets/images/skills/c++.png',
          title: 'C++'
        }, {
          ...
          imgUrl: 'assets/images/skills/qt.png',
          title: 'Qt'
        }, {
      ...
      toolsItems: [
        {
          ...
          imgUrl: 'assets/images/skills/eclipse.png',
          title: 'Eclipse'
        }, {
          imgUrl: 'assets/images/skills/vs-code.png',
          title: 'VS Code'
        }, {
          imgUrl: 'assets/images/skills/microsoft-teams.png',
          title: 'Microsoft Teams'
        }, {
          imgUrl: 'assets/images/skills/microsoft-office.png',
          title: 'Microsoft Office'
        }, {
          imgUrl: 'assets/images/skills/intelliJ.png',
          title: 'Intellij'
        }, {
          imgUrl: 'assets/images/skills/data-grip.png',
          title: 'Data Grip'
        }, {
      ...
      experienceItems: [
        {
          date: '2007',
          companyName: { en: 'Schraberg - Grundschule'},
          jobTitle: { en: 'Student'},
          desc: {
          ...
          date: '2011',
          companyName: { en: 'Friedrich-Harkort-Gymnasium'},
          jobTitle: { en: 'Student'},
          desc: {
            en: 'Achived Certificate - Abitur (Allgemeine Hochschulreife).',
          }
        }, {
          date: '2019',
          companyName: { en: 'Finanzverwaltung NRW'},
          jobTitle: { en: 'Student (Duales Studium)'},
          desc: {
            en: 'Canceld after 07.04.2020.',
          }
        }, {
          date: '2020',
          companyName: { en: 'GUS Deutschland'},
          jobTitle: { en: 'Software Engenier (Anwendungsentwickler)'},
          desc: {
            en: 'Building and Maintaining Software Infrastracture and developing it further.',
          }
        }, {}, {}
      ],
      ...
      allPortfolioItems: [
        {
          url: 'https://github.com/BenCoepp/hang-man',
          imgUrl: 'assets/images/portfolio/hangman.png',
          title: { en: 'Hang-Man'},
          desc: { en: 'March 2021'},
          category: { slug: 'qt', name: 'Qt' }
        }, {
          url: 'https://github.com/BenCoepp/truth_and_dare',
          imgUrl: 'assets/images/portfolio/truthanddare.png',
          title: { en: 'Truth & Dare'},
          desc: { en: 'July 2021'},
          category: { slug: 'flutter', name: 'Flutter' }
        }, {
          url: 'https://www.amazon.com/dp/B095MD5G7D',
          imgUrl: 'assets/images/portfolio/bootstrapstudio.png',
          title: { en: 'A Guide to Bootstrap Studio'},
          desc: { en: 'April 2021'},
          category: { slug: 'book', name: 'Book' }
        }, {
          url: 'https://github.com/BenCoepp/bencoepp',
          imgUrl: 'assets/favicon.ico',
          title: { en: 'BenCoepp - Portfolio'},
          desc: { en: 'April 2021'},
          category: { slug: 'vue', name: 'Vue' }
        }, {
          url: 'https://github.com/BenCoepp/Legacy',
          imgUrl: 'assets/images/portfolio/legacy.png',
          title: { en: 'Legacy'},
          desc: { en: 'August 2020'},
          category: { slug: 'qt', name: 'Qt' }
        }, {
          url: 'https://www.amazon.com/gp/product/B08XLLDZSG',
          imgUrl: 'assets/images/portfolio/qt6guide.png',
          title: { en: 'A Guide to Qt 6'},
          desc: { en: 'March 2021'},
          category: { slug: 'book', name: 'Book' }
        }
      ].reverse(),
